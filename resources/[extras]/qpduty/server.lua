...
RegisterServerEvent('PoliceDuty:police')
AddEventHandler('PoliceDuty:police', function(job)
...
RegisterServerEvent('AmbulanceDuty:ambulance')
AddEventHandler('AmbulanceDuty:ambulance', function(job)
